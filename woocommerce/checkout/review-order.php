	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			<?php if ( wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) { 
				...
				<p class="form-row terms" style="width: 68%;">
					<label for="terms" class="checkbox">
							Mit der Anmeldung akzeptiere ich die  <a href="<?php echo esc_url( get_permalink(wc_get_page_id('terms')) ); ?>" target="_blank"><?php _e( 'AGB', 'woocommerce' ); ?></a>
					</label>
